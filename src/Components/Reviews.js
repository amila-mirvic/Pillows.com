...
const Reviews = () => {
  ...
  const translateX = `translateX(${-currentIndex * 33.33}%)`;
    ...
    <g transform="translate(-693.81 -2814.695)">
     ...
     <path
      ...
      <div className="reviews-carousel">
        <div className="carousel-wrapper" style={{ transform: translateX }}>
          <div className="review-box">
            ...
            <h3 className='highlight'>Best pillow I’ve ever had!</h3>
            <p className='review-text'>Been sleeping on this little cloud for a month now and I LOVE it! It’s so so soft and makes me feel like a well rested baby. Thank you Pillows.com!</p>
            <p className='name'>- Jessica R.</p>
          </div>
          <div className="review-box">
            <div className="stars">
              {[...Array(5)].map((_, index) => (
            ...
            <h3 className='highlight'>Finally found the perfect pillow!</h3>
            <p className='review-text'>I was a skeptic until I laid my lovely head on this pillow. I was really shocked that the pillow kept its fluff this long. I love it and will be buying more.</p>
            <p className='name'>- Alex S.</p>
          </div>
          <div className="review-box">
            <div className="stars">
              {[...Array(5)].map((_, index) => (
            ...
            <h3 className='highlight'>Seriously THE best!</h3>
            <p className='review-text'>These are the SOFTEST and coziest pillows ever! I have to get into bed fast before my dogs take them!</p>
      ...
      <button className="reviews-button">Read All Reviews</button>
    </div>
  );
};
